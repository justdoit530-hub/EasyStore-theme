  ...
  customElements.define('share-button', class ShareButton extends HTMLElement {
    constructor() {
      ...
      if (navigator.share) {
        ...
        const copyButton = this.mainDetailsToggle.querySelector('.share-button__copy');
        const closeButton = this.mainDetailsToggle.querySelector('.share-button__close');
        if (copyButton) copyButton.addEventListener('click', this.copyToClipboard.bind(this));
